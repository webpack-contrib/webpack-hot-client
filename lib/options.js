...
module.exports = (opts) => {
  ...
  if (process.env.WHC_TARGET) {
    options.validTargets.push(process.env.WHC_TARGET);
    process.emitWarning(
      'webpack-hot-client: The `WHC_TARGET` envar is deprecated and will be removed in next version. Please use the `validTargets` option'
    );
  }
  ...
  if (typeof options.hot !== 'undefined') {
    ...
    process.emitWarning(
      'webpack-hot-client: The `hot` option is deprecated and will be removed in next version. Please use the `hmr` option'
    );
  }
